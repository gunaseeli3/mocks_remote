...
<div class="modal fade" id="confirmationModal" tabindex="-1" role="dialog" aria-labelledby="confirmationModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <p>¿Estas seguro que quieres cargar este archivo de sensores?</p>
            </div>
            <div class="modal-footer">
...
$(document).ready(function () {
    ...
    $.ajax({
            url: "templates/metrologia/includes/proceso_sensor.php?mod=check",
            type: "POST",
            data: formData,
            processData: false,
            contentType: false,
...
if (response.errorMessages.length === 0 && response.duplicatedSensorsInFile.length === 0 && response.duplicatedSensors.length === 0) {  
   ...
   // Populate the duplicated sensor list if available
    ...
    $("#process").click(function () {
         ...
         var progress = $(".loading-progress").progressTimer({
             timeLimit: 1, // Set the time limit in milliseconds (10 seconds in this example)
             onFinish: function () {
         ...
         $.ajax({
             url: "templates/metrologia/includes/proceso_sensor.php?mod=process",
             type: "POST",
             data: formData,
             processData: false,
             contentType: false,
