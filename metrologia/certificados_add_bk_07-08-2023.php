            ...
            <form method="post" enctype="multipart/form-data">
                <div class="form-row" style="margin-bottom: 10px;">
                    ...
                    <div style="text-align:center;">
					 		...
					 		<button type="submit" name="submit_action" value="Edit Category" class="mb-2 mr-2 btn-icon btn-shadow btn-outline-2x btn btn-outline-success">Agregar certificado</button>
