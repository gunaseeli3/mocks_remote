<?php
 ...
 function updateDatabaseAndBacktrack($certificateId, $sensorId, $tipo) {
    global $db_cms;
...
if (isset($_POST['tipo'])) {
updateDatabaseAndBacktrack($certificateId, $sensorId, $tipo, $_POST);
}
else{
    updateDatabaseAndBacktrack($certificateId, $sensorId, 'Primario', $_POST); 
}
