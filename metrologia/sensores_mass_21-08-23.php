    ...
    <div class="card">
        <div class="card-header">
            ...
            <div class="btn-actions-pane-right">
                <a href="templates/metrologia/ejemplo-only-sensores.xlsx" target="_blank" class="mb-2 mr-2 btn-icon btn-shadow btn-outline-2x btn btn-outline-primary"><i class="fa-regular fa-file-excel btn-icon-wrapper"></i> Ejemplo Excel</a>
...
$(document).ready(function () {
    ...
    $("#confirmUploadButton").click(function () {
        ...
        var progress = $(".loading-progress").progressTimer({
            timeLimit: 5, // Time limit in milliseconds
            onFinish: function () {}
        });
