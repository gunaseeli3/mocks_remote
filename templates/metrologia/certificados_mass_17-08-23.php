...
$(document).ready(function () {
    ...
    $.ajax({
        url: "templates/metrologia/includes/proceso.php?sensor_id=<?php echo $sensor_id; ?>",
        type: "POST",
        data: formData,
        processData: false,
        contentType: false,
...
// Construct the URL using the certificate name
 
//var certificateUrl = certificate.url ;
    
    // Create a link element with the URL
  ////  var certificateLink = '<a  target="_blank"  href="' + certificateUrl + '">' + certificate.certificado + '</a>';
