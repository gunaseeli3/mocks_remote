...
if (isset($_FILES['pdf_file']) && $_FILES['pdf_file']['error'] === UPLOAD_ERR_OK) {
    ...
    $sql31 = "SELECT * FROM sensores_certificados WHERE id_certificado = '$certificateId'";
    $res_bf2 = $db_cms->select_query_with_row($sql31);

    // Define the existing file path based on your logic
    $existingFile = dirname(__FILE__) . "/../../templates/certificados/{$sensorId}/{$res_bf2['certificado']}.pdf";
