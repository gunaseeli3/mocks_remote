...
foreach ($backtrackData as $entry) {
    ...
    $dbTimestamp = new DateTime($entry['fecha'], new DateTimeZone('UTC')); // Assuming the timestamp is stored in UTC
    $dbTimestamp->setTimezone(new DateTimeZone('America/Santiago'));
